  ...
  const posts = [
    {
      ...
      content:
        "Estamos muito felizes em anunciar que novos equipamentos de musculação chegarão na próxima semana! Entre as novidades, teremos esteiras de última geração com telas touch screen integradas, novos equipamentos para treino funcional e uma área completamente renovada para exercícios de peso livre. Estas atualizações fazem parte do nosso compromisso contínuo em oferecer a melhor experiência possível para nossos alunos.",
    ...
    },
    {
      ...
      content:
        "Começando no próximo mês, teremos uma nova turma de yoga para iniciantes! As aulas acontecerão nas terças e quintas, das 7h às 8h, com a professora Maria. Venha experimentar esta prática milenar que combina exercícios físicos, respiração e meditação para promover bem-estar físico e mental.",
  ...
  const forumTopics = [
    {
      ...
      preview:
        "Pessoal, estou com uma dúvida sobre a execução correta do agachamento. Alguém poderia me ajudar?",
    },
    {
      id: 2,
      ...
      preview:
        "3 meses de treino consistente e já posso ver resultados impressionantes! Aqui está minha jornada...",
    },
    {
      id: 3,
      ...
      preview:
        "Com o verão chegando, quais são as melhores práticas para manter o treino mesmo nos dias mais quentes?",
    },
  ];
