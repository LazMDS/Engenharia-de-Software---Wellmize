...
import { Users, Clock, Dumbbell, Calendar, Trophy, Target, Instagram, TrendingUp, MessageCircle, Moon, Sun, Settings, User, Bell, Share2, Shield, HelpCircle, Globe, ChevronRight, Mail, Phone, MapPin, Facebook, Twitter, Eye, EyeOff, Type, Languages, MessageSquareQuote as MessageSquareQuestion, FileQuestion, Contact } from 'lucide-react';
...
function Setting() {
    ...
    const renderSettingsContent = () => {
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">Mensagens Motivacionais</span>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                        type="checkbox"
                        checked={notifications.motivational}
                        onChange={(e) => setNotifications({...notifications, motivational: e.target.checked})}
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">Lembretes Diários</span>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                        type="checkbox"
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">Alertas de Check-in</span>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                        type="checkbox"
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">Mostrar Perfil</span>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                        type="checkbox"
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">Mostrar Atividade</span>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                        type="checkbox"
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">Mostrar Progresso</span>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                        <input
                        type="checkbox"
        ...
        case 'accessibility':
            ...
            <div className="space-y-6">
                <div className="space-y-4">
                <h4 className="font-medium text-gray-900 dark:text-white">Acessibilidade</h4>
                
                {/* Font Size */}
                <div className="space-y-2">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Tamanho da Fonte</label>
                    <select
                    value={fontSize}
        ...
        case 'support':
            ...
            <div className="space-y-6">
                ...
                <h4 className="font-medium text-gray-900 dark:text-white mb-4">Perguntas Frequentes</h4>
                <div className="space-y-4">
                    <details className="group">
                    <summary className="flex items-center justify-between cursor-pointer list-none">
                        <span className="text-gray-700 dark:text-gray-300">Como alterar minha senha?</span>
                        <ChevronRight className="w-5 h-5 text-gray-500 group-open:rotate-90 transition-transform" />
                    </summary>
                    <p className="mt-2 text-gray-600 dark:text-gray-400">
                        Para alterar sua senha, vá até a seção de perfil e clique em "Alterar Senha". Você precisará informar sua senha atual e a nova senha.
                    </p>
                    </details>
                    <details className="group">
                    <summary className="flex items-center justify-between cursor-pointer list-none">
                        <span className="text-gray-700 dark:text-gray-300">Como agendar um horário?</span>
                        <ChevronRight className="w-5 h-5 text-gray-500 group-open:rotate-90 transition-transform" />
                    </summary>
                    <p className="mt-2 text-gray-600 dark:text-gray-400">
                        Na tela principal, clique em "Agendar" e escolha o horário desejado. Você pode ver a disponibilidade em tempo real.
                    </p>
                    </details>
                </div>
                </div>
                ...
                {/* Contact Form */}
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                <h4 className="font-medium text-gray-900 dark:text-white mb-4">Contato</h4>
        ...
        case 'language':
            ...
            <div className="space-y-6">
                ...
                <div>
                    <h3 className="text-lg font-semibold dark:text-white">João Silva</h3>
                    <p className="text-gray-600 dark:text-gray-400">Membro desde 2024</p>
                </div>
                </div>
                ...
                <div className="space-y-4">
                <h4 className="font-medium text-gray-900 dark:text-white">Redes Sociais</h4>
                <div className="space-y-3">
